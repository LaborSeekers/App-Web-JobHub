...
export class OfertantesComponent implements OnInit {
  links = [
    { route: ['inicio'], image: "assets/imagenes/Nav-bar/capas2.png",selectedImage:"assets/imagenes/Nav-bar/capas.png", alt: "capa", id: "capaoverview", text: "Descripción General" },
    ...
    { route: ['/route/path'], image: "assets/imagenes/Nav-bar/image18.png",selectedImage:"assets/imagenes/Nav-bar/image18.png", alt: "image18", id: "marcador-overview", text: "Ver Postulantes" },
